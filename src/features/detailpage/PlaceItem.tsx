...
const PlaceItem = () => {
  return (
    <div className="border-t py-[15px]">
      ...
      <div className="flex flex-col text-text-sm text-primary-400">
        ...
        <CarouselContent className="gap-2.5 flex">
          {[...Array(3)].map((_, idx) => (
            <CarouselItem className="flex-none web:basis-1/4" key={idx}>
              <img src={mockImg} alt="mockImg" className="w-[245px]" />
            </CarouselItem>
          ))}
        </CarouselContent>
      </Carousel>
      ...
      <p className="text-primary-400 text-text-sm mt-2.5">
